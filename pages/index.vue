  ...
  .container-fluid.shapes
    .container.p-5
      .columns.is-centered.is-multiline
        ...
        //-   .columns.is-multiline
        //-     .column.is-4
        //-       img(class="image" src="~assets/oats.jpg" style="object-fit: cover;").box.p-0
        //-     .column.is-4
        //-       img(class="image" src="~assets/apple.jpeg" style="object-fit: cover;").box
        //-     .column.is-4
        //-       .box
        //-         | sup
        //-     .column.is-4
        ...
        //-         | sup
      .columns.is-multiline
        .column.is-offset-3.is-6.is-centered
          .columns.is-multiline
            .surround.column.is-12
              span.is-size-2 1
              span.is-size-4.ml-3.has-text-darkgrey Customize nutrients
            .surround.column.is-12
              span.is-size-2 2
              span.is-size-4.ml-3.has-text-darkgrey Choose a food collection
            .surround.column.is-12
              span.is-size-2 3
              span.is-size-4.ml-3.has-text-darkgrey Optimize
      .columns.py-5
