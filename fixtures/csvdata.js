...
// Note: Full credit to Alessandro Zanard for all this code
// I just needed to make a few adjustments to use more of the internal require('csv') options (Namely: quote)
